(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v14`;
  ...
  const featureLibrary = [
    ...
    { id: "section-layouts", title: "Section layouts", target: ["section", "page"], icon: "▦", description: "Safe responsive layout presets for sections and cards.", options: ["layout-safe-container", "layout-balanced-section", "layout-responsive-cards", "section-split-grid", "section-sticky-pin"] }
  ];
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v14 · stable editor</div>
          </div>
