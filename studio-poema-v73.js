(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v73`;
  ...
  function isDesignerMode() {
    const params = new URLSearchParams(location.search);
    const editorValue = params.get("ssx_editor") || params.get("ssx") || "";
    const keyValue = params.get("ssx_key") || "";
...
`;
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v71 · private editor mode</div>
          </div>
  ...
  function cleanRuntimeSrc() {
    const fallback = `https://cdn.jsdelivr.net/gh/evaldasbanevici-del/SquarePlugin@main/studio-poema-v73.js?v=${defaultConfig.version}`;
    try {
