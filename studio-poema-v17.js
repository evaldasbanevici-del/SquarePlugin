(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v17`;
...
`;
  ...
  function ensureBaseStyles() {
    ...
    style.textContent = `
      ...
      .ssx-outline{outline:3px dashed #ff65f0!important;outline-offset:6px!important;box-shadow:0 0 0 10px rgba(255,101,240,.12)!important}
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v17 · text foundation</div>
          </div>
        ...
        <div class="ssx-body">
          <main class="ssx-main">
            ${helpOpen ? `<section class="ssx-how">
              ...
              <p>Select a block, open Text, then add only tested text effects. This v17 build keeps changes versioned cleanly.</p>
            </section>` : ""}
            ${renderMainContent()}
          </main>
        </div>
