(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v33`;
  ...
  const textEffectExtras = [
    ...
    },
    {
      ...
      intensityLabel: "Weight",
      preview: "type-editorial",
      css: (s, i) => `${s} :is(h1,h2,h3,p,li,a){font-weight:${Math.round(620 + i * 280)}!important;}`
    },
    {
      ...
      preview: "type-luxury",
      css: (s) => `${s} :is(h1,h2,h3,p,li,a){font-style:italic!important;}`
    },
    {
      ...
      preview: "type-luxury",
      css: (s, i) => `${s} :is(h1,h2,h3,p,li,a){text-transform:uppercase!important;letter-spacing:${(0.02 + i * .14).toFixed(2)}em!important;}`
    },
    {
      id: "txt-size-desktop",
      ...
      intensityLabel: "Size",
      preview: "type-editorial",
      css: (s, i) => `${s} :is(p,li,a){font-size:clamp(16px,${(0.9 + i * 1.1).toFixed(2)}vw,${Math.round(18 + i * 18)}px)!important;} ${s} :is(h1,h2,h3){font-size:clamp(32px,${(2.4 + i * 4.8).toFixed(2)}vw,${Math.round(54 + i * 70)}px)!important;}`
    },
    {
      id: "txt-size-mobile",
      ...
      preview: "type-editorial",
      css: (s, i) => `@media(max-width:767px){${s} :is(p,li,a){font-size:${Math.round(14 + i * 10)}px!important;} ${s} :is(h1,h2,h3){font-size:${Math.round(28 + i * 34)}px!important;}}`
    },
    {
      id: "txt-line-gap",
      ...
      intensityLabel: "Gap",
      preview: "type-balance",
      css: (s, i) => `${s} :is(p,li){line-height:${(1.25 + i * .75).toFixed(2)}!important;} ${s} :is(h1,h2,h3){line-height:${(0.92 + i * .34).toFixed(2)}!important;}`
    },
    {
      id: "txt-align-left",
      label: "Align · Left",
      ...
      preview: "layout-split",
      css: (s) => `${s}{text-align:left!important;} ${s} :is(h1,h2,h3,p,li){text-align:left!important;}`
    },
    {
      id: "txt-align-center",
      label: "Align · Center",
      ...
      intensityLabel: "Align",
      preview: "layout-frame",
      css: (s) => `${s}{text-align:center!important;} ${s} :is(h1,h2,h3,p,li){text-align:center!important;margin-left:auto!important;margin-right:auto!important;}`
    },
    {
      id: "txt-align-right",
      label: "Align · Right",
      ...
      intensityLabel: "Align",
      preview: "layout-split",
      css: (s) => `${s}{text-align:right!important;} ${s} :is(h1,h2,h3,p,li){text-align:right!important;margin-left:auto!important;}`
    },
    {
    ...
    },
    {
      ...
      intensityLabel: "Ink",
      preview: "type-highlight",
      css: (s, i, _settings, theme) => `${s} :is(h1,h2,h3){display:inline;background-image:linear-gradient(transparent ${Math.round(78 - i * 22)}%,${hexToRgba(theme.accent,.38 + i * .48)} 0);background-repeat:no-repeat;background-size:100% 100%;}`
    },
    {
      ...
      intensityLabel: "Stroke",
      preview: "type-outline",
      css: (s, i, _settings, theme) => `${s} :is(h1,h2){-webkit-text-stroke:${Math.round(1 + i * 3)}px ${theme.primary};color:${hexToRgba(theme.primary,.03 + i * .11)}!important;text-shadow:none!important;}`
    },
    {
      id: "txt-heading-colorful",
      label: "Heading · Color split",
      description: "Gives headings a controlled two-tone color treatment.",
      intensityLabel: "Mix",
      preview: "type-gradient",
      css: (s, i, _settings, theme) => `${s} :is(h1,h2,h3){color:${theme.ink}!important;} ${s} :is(h1,h2,h3) strong,${s} :is(h1,h2,h3) em{color:${i > .52 ? theme.accent : theme.primary}!important;font-style:normal;}`
    },
    {
      id: "txt-heading-fill",
      ...
      intensityLabel: "Fill",
      preview: "type-highlight",
      css: (s, i, _settings, theme) => `${s} :is(h1,h2){display:inline;box-decoration-break:clone;-webkit-box-decoration-break:clone;background:${hexToRgba(theme.accent,.22 + i * .45)};padding:.02em .14em;border-radius:${Math.round(2 + i * 18)}px;}`
    },
    {
      id: "txt-heading-strong-fill",
      label: "Heading · Strong fill",
      description: "Bold block highlight for important words.",
      intensityLabel: "Height",
      preview: "type-highlight",
      css: (s, i, _settings, theme) => `${s} :is(h1,h2,h3) strong{background:${theme.accent};color:${theme.ink};padding:.02em .16em;border-radius:${Math.round(2 + i * 10)}px;box-decoration-break:clone;-webkit-box-decoration-break:clone;}`
    },
    {
      id: "txt-heading-candy",
      label: "Heading · Ribbon stripe",
      description: "A more playful stripe fill inspired by candy-ribbon headings.",
      intensityLabel: "Stripe",
      preview: "type-gradient",
      css: (s, i, _settings, theme) => `${s} :is(h1,h2){background:repeating-linear-gradient(110deg,${theme.primary} 0 ${Math.round(8+i*12)}px,${theme.accent} ${Math.round(8+i*12)}px ${Math.round(16+i*24)}px);-webkit-background-clip:text;background-clip:text;color:transparent!important;}`
    },
    {
    ...
    },
    {
      ...
      css: (s, i, settings) => `${s}{transition:transform ${Math.max(.28, 1.15 - i * .72).toFixed(2)}s ease,opacity ${Math.max(.28, 1.15 - i * .72).toFixed(2)}s ease;} ${s}.ssx-parallax:not(.ssx-in){opacity:.15;transform:translateY(${Math.round(22 + param(settings, "distance", 70) * 1.45)}px);}`
    },
    {
      id: "txt-scroll-left",
      ...
      css: (s, i, settings) => `${s}{transition:transform ${Math.max(.28, 1.15 - i * .72).toFixed(2)}s cubic-bezier(.2,.8,.2,1),opacity ${Math.max(.28, 1.15 - i * .72).toFixed(2)}s ease;} ${s}.ssx-reveal:not(.ssx-in){opacity:0;transform:translateX(${Math.round(36 + param(settings, "distance", 72) * 1.9)}px);}`
    },
    {
      id: "txt-scroll-right",
    ...
    },
    {
      ...
      css: (s, i, settings) => `${s}{transition:transform ${Math.max(.28, 1.15 - i * .72).toFixed(2)}s cubic-bezier(.2,.8,.2,1),opacity ${Math.max(.28, 1.15 - i * .72).toFixed(2)}s ease;} ${s}.ssx-reveal:not(.ssx-in){opacity:0;transform:scale(${(1 - (0.08 + param(settings, "distance", 55) * .0025)).toFixed(2)});}`
    },
    {
    ...
    },
    {
      ...
      preview: "motion-reveal",
      className: "ssx-reveal",
      css: (s, i) => `${s}{transition:opacity ${Math.max(.28, 1.15 - i * .72).toFixed(2)}s ease;} ${s}.ssx-reveal:not(.ssx-in){opacity:0;}`
    },
    {
      id: "txt-loop-pulse",
      label: "Loop · Pulse",
    ...
    },
    {
      ...
      intensityLabel: "Size",
      preview: "cursor-dot",
      css: (s, i) => `${s},${s} *{cursor:none!important;} ${s}{--ssx-cursor-size:${Math.round(28+i*34)}px;}`
    },
    {
      id: "txt-cursor-large",
      ...
      intensityLabel: "Size",
      preview: "cursor-dot",
      css: (s, i) => `${s},${s} *{cursor:none!important;} ${s}{--ssx-cursor-size:${Math.round(26+i*42)}px;}`
    },
    {
      id: "txt-cursor-hide",
    ...
    {
      id: "txt-cursor-text-right",
      label: "Cursor · Text leans right",
      description: "Pairs cursor areas with right-aligned text styling.",
      intensityLabel: "Right",
      preview: "type-editorial",
      css: (s, i, _settings, theme) => `${s}{text-align:right!important;cursor:pointer;} ${s} :is(h1,h2,h3,p,a){color:${theme.primary}!important;font-size:${Math.round(16+i*18)}px!important;line-height:${(1.18+i*.52).toFixed(2)}!important;}`
    }
  ];
  ...
  const imageEffectExtras = [
    ...
    },
    {
      ...
      intensityLabel: "Opacity",
      preview: "hover-overlay",
      css: (s, i, _settings, theme) => `${mediaWrappers(s)}{position:relative!important;overflow:hidden!important;} ${mediaWrappers(s)}:after{content:"View";position:absolute;inset:0;background:${hexToRgba(theme.primary,.18+i*.46)};color:${theme.soft};display:grid;place-items:center;font-weight:900;font-size:clamp(18px,3vw,34px);opacity:0;transition:opacity .22s ease;pointer-events:none;} ${mediaWrappers(s)}:hover:after{opacity:1;}`
    },
    {
      id: "img-click-pill",
      ...
      intensityLabel: "Size",
      preview: "button-radius",
      css: (s, i, _settings, theme) => `${mediaWrappers(s)}{position:relative!important;} ${mediaWrappers(s)}:after{content:"Open";position:absolute;left:14px;bottom:14px;background:${theme.accent};color:${theme.ink};border-radius:999px;padding:${Math.round(6+i*6)}px ${Math.round(12+i*14)}px;font-weight:900;font-size:${Math.round(12+i*8)}px;opacity:0;transform:translateY(8px);transition:opacity .22s ease,transform .22s ease;pointer-events:none;} ${mediaWrappers(s)}:hover:after{opacity:1;transform:translateY(0);}`
    },
    {
  ...
  const textSections = [
    ...
    { id: "heading", icon: "H", title: "Heading styles", description: "Display treatments for headings.", options: ["txt-heading-gradient-live", "txt-heading-underline", "txt-heading-stroke", "txt-heading-colorful", "txt-heading-fill", "txt-heading-strong-fill", "txt-heading-candy"] },
    ...
    { id: "scroll", icon: "↕", title: "Animate on scroll", description: "Smooth animations that move as text enters view.", options: ["txt-scroll-parallax", "txt-scroll-left", "txt-scroll-right", "txt-scroll-up", "txt-scroll-down", "txt-scroll-scale-up", "txt-scroll-scale-down", "txt-scroll-fade"] },
    ...
    { id: "cursor", icon: "☝", title: "Cursor on hover", description: "Custom cursor and hover text helpers.", options: ["txt-cursor-emoji", "txt-cursor-large", "txt-cursor-hide", "txt-cursor-text-right"] }
  ];
  const imageSections = [
  ...
  function targetKind(selector) {
    ...
    if (!element) return selector.includes("section") || selector.includes("data-section-id") ? "section" : "section";
  ...
  function featuresForCurrentTarget() {
    ...
    const preferredOrder = kind === "button"
      ? ["text-suite", "image-suite"]
      : kind === "text"
        ? ["text-suite", "image-suite"]
        : kind === "image"
          ? ["image-suite", "text-suite"]
          : kind === "page"
            ? ["text-suite", "image-suite"]
            : ["text-suite", "image-suite"];
    return all.sort((a, b) => {
...
`;
  ...
  function ensureBaseStyles() {
    ...
    style.textContent = `
      ...
      .ssx-collapsed{position:fixed;right:138px;top:12px;bottom:auto;z-index:2147483647;border:1px solid rgba(5,25,20,.18);background:#FCF6EB;color:#051914;border-radius:999px;height:38px;padding:0 13px 0 10px;font:850 12px Inter,ui-sans-serif,system-ui,sans-serif;box-shadow:0 10px 28px rgba(5,25,20,.18);cursor:pointer;display:inline-flex;align-items:center;gap:8px;letter-spacing:0}
      .ssx-collapsed:before{content:"";width:18px;height:18px;border-radius:999px;background:#AADD66;box-shadow:inset 0 0 0 5px #125B49}
      .ssx-collapsed:hover{transform:translateY(-1px);box-shadow:0 14px 34px rgba(5,25,20,.22)}
      .ssx-collapsed.ssx-sqs-docked{position:absolute!important;top:50%!important;right:auto!important;left:auto!important;transform:translateY(-50%)!important;margin-left:8px!important}
      ...
      .ssx-upgrade{background:#dfe8d8!important;color:#17451f!important;border-bottom:1px solid rgba(23,69,31,.12)}
      .ssx-device-row,.ssx-mode-tabs,.ssx-tabs,.ssx-target,.ssx-footer{background:#f7f2e8!important;border-color:rgba(23,69,31,.12)!important}
      ...
      #${APP_ID} .ssx-panel,#${APP_ID} .ssx-main,#${APP_ID} .ssx-device-row,#${APP_ID} .ssx-mode-tabs,#${APP_ID} .ssx-tabs,#${APP_ID} .ssx-target,#${APP_ID} .ssx-footer{background:#FCF6EB!important;color:#051914!important}
      #${APP_ID} .ssx-head,#${APP_ID} .ssx-upgrade{background:#ECEABE!important;color:#051914!important;border-color:rgba(0,53,39,.14)!important}
      ...
      #${APP_ID} .ssx-footer{display:grid!important;grid-template-columns:1fr 1.25fr!important;gap:10px!important;padding:14px 18px 18px!important;border-top:1px solid rgba(5,25,20,.10)!important;background:rgba(252,246,235,.82)!important;backdrop-filter:blur(18px)!important;-webkit-backdrop-filter:blur(18px)!important}
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v33 · text + image studio</div>
          </div>
          <div class="ssx-icon-row">
            ...
            <button class="ssx-icon" type="button" data-ssx-clear title="Reset all">↺</button>
  ...
  function renderMainContent() {
    ...
    if (activeMode === "Studio") return renderStudioDashboard();
  ...
  function renderBlockStylingControls() {
    ...
    return `
      <label class="ssx-control-line"><span>Opacity</span><em>${opacity.enabled ? `${opacityValue}%` : "100%"}</em><input type="range" min="0" max="100" value="${opacityValue}" data-ssx-intensity="txt-block-opacity" data-ssx-auto-enable="true"></label>
      <label class="ssx-control-line"><span>Rotate</span><em>${rotate.enabled ? `${Math.round((rotateValue - 50) * .18)}°` : "0°"}</em><input type="range" min="0" max="100" value="${rotateValue}" data-ssx-intensity="txt-block-rotate" data-ssx-auto-enable="true"></label>
      <label class="ssx-control-line"><span>Blur</span><em>${blur.enabled ? `${Math.round(blurValue * .08)}px` : "0px"}</em><input type="range" min="0" max="100" value="${blurValue}" data-ssx-intensity="txt-block-blur" data-ssx-auto-enable="true"></label>
      <button class="ssx-control-line" type="button" data-ssx-switch-effect="txt-block-background"><span>Background</span><b class="ssx-toggle-dot ${background.enabled ? "is-on" : ""}"></b></button>
      <div class="ssx-control-grid">
        <label class="ssx-control-card">
          <span>Color</span>
          <input type="color" value="${escapeHtml(theme.gradientB || defaultConfig.theme.gradientB)}" data-ssx-color="gradientB">
        </label>
        <label class="ssx-control-card">
          <small>Corners</small><span>${cornerValue > 66 ? "Round" : cornerValue < 34 ? "Sharp" : "Softer"}</span>
          <input type="range" min="0" max="100" value="${cornerValue}" data-ssx-intensity="txt-block-corners" data-ssx-auto-enable="true">
        </label>
      </div>
      <button class="ssx-control-line" type="button" data-ssx-switch-effect="txt-block-border"><span>Border</span><b class="ssx-toggle-dot ${border.enabled ? "is-on" : ""}"></b></button>
      <button class="ssx-control-line" type="button" data-ssx-switch-effect="txt-block-shadow"><span>Shadow</span><b class="ssx-toggle-dot ${shadow.enabled ? "is-on" : ""}"></b></button>
      <label class="ssx-control-line"><span>Top & bottom</span><em>${margin.enabled ? `${Math.round(8 + (marginValue / 100) * 72)}px` : "0px"}</em><input type="range" min="0" max="100" value="${marginValue}" data-ssx-intensity="txt-block-margin" data-ssx-auto-enable="true"></label>
      <label class="ssx-control-line"><span>Left & right</span><em>${sideMargin.enabled ? `${Math.round((sideValue / 100) * 80)}px` : "0px"}</em><input type="range" min="0" max="100" value="${sideValue}" data-ssx-intensity="txt-block-margin-x" data-ssx-auto-enable="true"></label>
    `;
  }
  ...
  function renderCursorControls() {
    ...
    const textRight = blockSetting("txt-cursor-text-right");
    const sizeValue = large.enabled ? large.intensity || 60 : emoji.intensity || 60;
    return `
      <button class="ssx-control-line" type="button" data-ssx-switch-effect="txt-cursor-emoji"><span>Emoji cursor</span><em>☺</em><b class="ssx-toggle-dot ${emoji.enabled ? "is-on" : ""}"></b></button>
      ...
      <div class="ssx-control-title">Text helper</div>
      <button class="ssx-control-line" type="button" data-ssx-switch-effect="txt-cursor-text-right"><span>Text leans right</span><b class="ssx-toggle-dot ${textRight.enabled ? "is-on" : ""}"></b></button>
      <label class="ssx-control-line">
        <span>Text color</span>
        <input type="color" value="${escapeHtml((config.theme || defaultConfig.theme).primary)}" data-ssx-color="primary">
      </label>
    `;
  }
  ...
  function renderTextControls(section, effect, settings, disabled) {
    ...
    const colorRows = `
      ...
      <button class="ssx-control-line" type="button" data-ssx-text-choice="apply"><span>Apply style to</span><em>All words</em><b>›</b></button>
    `;
    if (section.id === "image-styles") {
      ...
      return `
        ...
        <button class="ssx-control-line" type="button" data-ssx-text-choice="corner"><span>Corner</span><em>${corner}</em><b>‹ ›</b></button>
    ...
    if (section.id === "image-click") {
      return `
        ...
        <button class="ssx-control-line" type="button" data-ssx-text-choice="text"><span>Text</span><em>${/pill/i.test(effect.id) ? "Pill" : "Custom"}</em><b>‹ ›</b></button>
        <label class="ssx-control-line"><span>Custom text</span><input type="text" value="${/pill/i.test(effect.id) ? "Open" : "View"}" disabled></label>
    ...
    if (section.id === "image-scroll") {
      ...
      return `
        ...
        <button class="ssx-control-line" type="button" data-ssx-text-choice="apply"><span>Apply style to</span><em>Selected image</em><b>›</b></button>
      `;
    }
    ...
    if (section.id === "scroll") {
      ...
      return `
        <label class="ssx-control-line"><span>Animation speed</span><em>${speed}</em><input type="range" min="0" max="100" value="${value}" data-ssx-intensity="${escapeHtml(effect.id)}" ${disabled ? "disabled" : ""}></label>
        ${effect.params && effect.params.length ? `<label class="ssx-control-line"><span>${escapeHtml(effect.params[0].label)}</span><em>${distance}</em><input type="range" min="0" max="100" value="${distance}" data-ssx-param-effect="${escapeHtml(effect.id)}" data-ssx-param-key="${escapeHtml(effect.params[0].key)}" ${disabled ? "disabled" : ""}></label>` : ""}
        <button class="ssx-control-line" type="button" data-ssx-text-choice="apply"><span>Apply style to</span><em>Selected text</em><b>›</b></button>
      `;
    }
    if (section.id === "block") {
      return `
    ...
    if (section.id === "cursor") {
      return `
        <button class="ssx-control-line" type="button"><span>Enter cursor here</span><em>${/emoji/i.test(effect.label) ? "☺" : "Dot"}</em></button>
        ...
        <div class="ssx-control-title">Text</div>
        <div class="ssx-control-grid">
          ${colorCard("Color", "primary")}
          <button class="ssx-control-card" type="button" data-ssx-switch-effect="txt-format-bold"><small>Formatting</small><span>Auto</span><b>‹ ›</b></button>
          <button class="ssx-control-card" type="button" data-ssx-switch-effect="txt-cursor-large"><small>Size</small><span>${size}</span><b>− +</b></button>
          <button class="ssx-control-card" type="button" data-ssx-switch-effect="txt-cursor-text-right"><small>Align</small><span>Right</span><b>− +</b></button>
          <button class="ssx-control-card" type="button"><small>Mobile size</small><span>Auto</span><b>− +</b></button>
          <label class="ssx-control-card"><small>Line gap</small><span>Auto</span><input type="range" min="0" max="100" value="${value}" data-ssx-intensity="${escapeHtml(effect.id)}" ${disabled ? "disabled" : ""}></label>
        </div>
      `;
    }
    return `
      <label class="ssx-control-line"><span>Animation speed</span><em>${speed}</em><input type="range" min="0" max="100" value="${value}" data-ssx-intensity="${escapeHtml(effect.id)}" ${disabled ? "disabled" : ""}></label>
      <button class="ssx-control-line" type="button"><span>Apply style to</span><em>Selected text</em><b>›</b></button>
    `;
  }
  ...
  function bindPanel(root) {
    ...
    root.querySelectorAll("[data-ssx-text-choice]").forEach((button) => {
      button.addEventListener("click", () => {
        showToast("Applies to selected text");
      });
    });
  ...
  function renderCollapsed() {
    ...
    button.type = "button";
    button.title = "Open Studio Poema";
    button.textContent = "Studio";
    button.addEventListener("click", () => {
      localStorage.setItem(PANEL_KEY, "1");
      renderPanel();
    });
    const dock = findSquarespaceDock();
    if (dock) {
      button.classList.add("ssx-sqs-docked");
  ...
  function cleanRuntimeSrc() {
    const fallback = `https://cdn.jsdelivr.net/gh/evaldasbanevici-del/SquarePlugin@main/studio-poema-v33.js?v=${defaultConfig.version}`;
    try {
