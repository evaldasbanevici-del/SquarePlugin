/* ============================================================
   FORMA — Squarespace customization plugin by Studio Poema
   v1.0.0 · Single-file injection · No dependencies
...
<div class="fm-fx" data-fx="${e.id}">
  ...
  /* ============================================================
     ...
     ============================================================ */
  function runtimeSrc() {
    const fallback = `https://cdn.jsdelivr.net/gh/evaldasbanevici-del/SquarePlugin@main/forma.js`;
    try {
