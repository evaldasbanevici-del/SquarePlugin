(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v18`;
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v18 · text foundation</div>
          </div>
        ...
        <div class="ssx-body">
          <main class="ssx-main">
            ${helpOpen ? `<section class="ssx-how">
              ...
              <p>Select a block, open Text, then add only tested text effects. This v18 build keeps changes versioned cleanly.</p>
            </section>` : ""}
            ${renderMainContent()}
          </main>
        </div>
