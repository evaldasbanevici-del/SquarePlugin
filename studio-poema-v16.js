(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v16`;
  ...
  const featureLibrary = [
    { id: "text-options", title: "Text options", target: ["text", "section", "page"], icon: "T", description: "Clean text editing base. Effects will be added one by one after testing.", options: [] },
    { id: "heading-styles", title: "Heading styles", target: ["text", "section", "page"], icon: "H", description: "Heading effects will start here after we verify each one.", options: [] },
    { id: "paragraph-styles", title: "Paragraph styles", target: ["text", "section", "page"], icon: "¶", description: "Paragraph effects will start here after we verify each one.", options: [] },
    { id: "link-styles", title: "Link styles", target: ["text", "section", "page"], icon: "↗", description: "Link effects will start here after we verify each one.", options: [] }
  ];
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v16 · text foundation</div>
          </div>
        ...
        <div class="ssx-body">
          <main class="ssx-main">
            ${helpOpen ? `<section class="ssx-how">
              ...
              <p>Select a block, open a text area, then add only tested text effects. This v16 base intentionally ships without active effects.</p>
            </section>` : ""}
            ${renderMainContent()}
          </main>
        </div>
