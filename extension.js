(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v4`;
  ...
  function ensureBaseStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      #${APP_ID}{position:fixed;top:14px;right:14px;width:min(460px,calc(100vw - 28px));max-height:calc(100vh - 28px);z-index:2147483647;color:#17351d;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:0}
      ...
      .ssx-main{padding:12px;overflow:auto;max-height:calc(100vh - 225px)}
