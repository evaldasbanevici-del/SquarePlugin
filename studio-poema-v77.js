(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v77`;
  ...
  function restoreButtonAdapter(button) {
    ...
    ["ssx-btn-animated-arrow-pill", "ssx-btn-bouncy-cta", "ssx-btn-letter-flip", "ssx-btn-swap-arrow", "ssx-btn-arrow-push", "ssx-button-adapter"].forEach((className) => button.classList.remove(className));
...
`;
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v77 · private editor mode</div>
          </div>
  ...
  function cleanRuntimeSrc() {
    const fallback = `https://cdn.jsdelivr.net/gh/evaldasbanevici-del/SquarePlugin@main/studio-poema-v77.js?v=${defaultConfig.version}`;
    try {
