(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v13`;
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v13 · simple editor</div>
          </div>
          <div class="ssx-icon-row">
            ...
            <button class="ssx-icon ssx-publish" type="button" data-ssx-publish title="Publish final code">Publish</button>
