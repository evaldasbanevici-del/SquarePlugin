(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v43`;
  ...
  function revealTextTargets(s) {
    return `.ssx-reveal:is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),.ssx-parallax:is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-reveal:is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-reveal :is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-parallax:is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-parallax :is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small)`;
  }

  function hiddenRevealTextTargets(s) {
    return `.ssx-reveal:not(.ssx-in):is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),.ssx-parallax:not(.ssx-in):is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-reveal:not(.ssx-in):is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-reveal:not(.ssx-in) :is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-parallax:not(.ssx-in):is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small),${s}.ssx-parallax:not(.ssx-in) :is(h1,h2,h3,h4,p,li,a,blockquote,.sqsrte-large,.sqsrte-small)`;
  }

  function wordRevealWordTargets(s) {
    return `.ssx-word-blur-reveal:is(h1,h2,h3,h4,p,li,blockquote,.sqsrte-large,.sqsrte-small) .ssx-word,${s}.ssx-word-blur-reveal:is(h1,h2,h3,h4,p,li,blockquote,.sqsrte-large,.sqsrte-small) .ssx-word,${s}.ssx-word-blur-reveal :is(h1,h2,h3,h4,p,li,blockquote,.sqsrte-large,.sqsrte-small) .ssx-word`;
  }

  function activeWordRevealWordTargets(s) {
    return `.ssx-word-blur-reveal.ssx-in:is(h1,h2,h3,h4,p,li,blockquote,.sqsrte-large,.sqsrte-small) .ssx-word,${s}.ssx-word-blur-reveal.ssx-in:is(h1,h2,h3,h4,p,li,blockquote,.sqsrte-large,.sqsrte-small) .ssx-word,${s}.ssx-word-blur-reveal.ssx-in :is(h1,h2,h3,h4,p,li,blockquote,.sqsrte-large,.sqsrte-small) .ssx-word`;
  }
  ...
  function motionTargetsFor(selector, effect) {
    ...
    const imageSelector = "img,picture,figure,.image-block,.sqs-block-image,.fluid-image-container";
...
`;
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v43 · block target fix</div>
          </div>
  ...
  function cleanRuntimeSrc() {
    const fallback = `https://cdn.jsdelivr.net/gh/evaldasbanevici-del/SquarePlugin@main/studio-poema-v43.js?v=${defaultConfig.version}`;
    try {
