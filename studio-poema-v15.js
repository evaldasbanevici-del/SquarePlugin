(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v15`;
  ...
  const featureLibrary = [
    { id: "animate-hover", title: "Animate on hover", target: ["text", "button", "image", "section", "page"], icon: "⌁", description: "Add tactile hover movement to selected content.", options: ["hover-transform-kit", "hover-color-border", "hover-overlay-reveal", "hover-text-reveal", "cursor-block-tilt"] },
    { id: "animate-scroll", title: "Animate on scroll", target: ["text", "button", "image", "section", "page"], icon: "↕", description: "Reveal, stagger or transform elements while scrolling.", options: ["motion-reveal", "motion-stagger", "motion-clip-reveal", "scroll-timeline-basic", "scroll-horizontal-track"] },
    { id: "animated-image-shapes", title: "Animated image shapes", target: ["image", "section", "page"], icon: "▱", description: "Round, mask and move image blocks.", options: ["image-rounded", "shape-blob-mask", "image-curtain-reveal", "motion-ken-burns"] },
    { id: "animated-shapes", title: "Animated shapes", target: ["section", "page"], icon: "△", description: "Add soft decorative shapes and glass panels.", options: ["shape-pills", "shape-glass-panel", "shape-soft-divider", "motion-micro-shimmer"] },
    { id: "block-styling", title: "Block styling", target: ["section", "text", "button", "image", "page"], icon: "✧", description: "Style blocks with backgrounds, frames, shadows and spacing.", options: ["section-soft-frame", "shape-glass-panel", "layout-safe-container", "layout-balanced-section"] },
    { id: "block-visibility", title: "Block visibility", target: ["section", "text", "button", "image", "page"], icon: "◌", description: "Hide selected content on smaller screens.", options: ["utility-hide-mobile"] },
    { id: "button-styles", title: "Button styles", target: ["button", "section", "page"], icon: "▭", description: "Solid, border, arrow, 3D, glass and playful CTA styles.", options: ["button-solid-style", "button-border-style", "button-magnetic", "button-arrow-style", "button-line-style", "button-3d-style", "button-glass", "button-snowy-style", "button-bubbly-style"] },
    { id: "cursor-hover", title: "Cursor on hover", target: ["section", "button", "text", "image", "page"], icon: "☝", description: "Make hover areas feel more interactive.", options: ["cursor-soft-dot", "cursor-link-magnet", "cursor-emoji", "cursor-block-tilt"] },
    { id: "dropdown-menu", title: "Dropdown menu styling", target: ["page", "section"], icon: "▾", description: "Make dropdowns softer and more premium.", options: ["nav-dropdown-glass", "nav-burger-polish"] },
    { id: "engagement-effects", title: "Engagement effects", target: ["button", "section", "page"], icon: "▣", description: "Pulse, wobble, hover and jelly effects for important buttons.", options: ["engagement-pulse", "engagement-wobble", "engagement-hovering", "engagement-jelly"] },
    { id: "gallery-styles", title: "Gallery styles", target: ["image", "section", "page"], icon: "▧", description: "Create floating or scrolling gallery movement.", options: ["image-floating-gallery", "image-infinite-gallery"] },
    { id: "header-links", title: "Header link styles", target: ["page", "section"], icon: "↗", description: "Style navigation links with line, pill and glass treatments.", options: ["nav-link-underline", "nav-pill-box", "nav-glass", "nav-sticky-hover"] },
    { id: "header-styles", title: "Header styles", target: ["page", "section"], icon: "▤", description: "Add glass, sticky hover and mobile menu polish.", options: ["nav-glass", "nav-sticky-hover", "nav-burger-polish"] },
    { id: "heading-styles", title: "Heading styles", target: ["text", "section", "page"], icon: "H", description: "Modern heading presets for templates.", options: ["text-gradient", "text-balanced", "text-typewriter", "text-3d-hover", "text-outline-trend", "text-split-luxury"] },
    { id: "image-click-indicator", title: "Image click indicator", target: ["image", "section", "page"], icon: "☝", description: "Make clickable images feel interactive on hover.", options: ["hover-image-filter", "image-zoom-hover", "hover-overlay-reveal"] },
    { id: "image-styles", title: "Image styles", target: ["image", "section", "page"], icon: "▧", description: "Image shadow, radius, tint and hover zoom.", options: ["image-soft-shadow", "image-rounded", "image-zoom-hover", "image-duotone"] },
    { id: "mobile-menu", title: "Mobile menu styling", target: ["page", "section"], icon: "▯", description: "Refine burger icon and mobile menu surface.", options: ["nav-burger-polish", "nav-glass"] },
    { id: "paragraph-styles", title: "Paragraph styles", target: ["text", "section", "page"], icon: "¶", description: "Improve paragraph rhythm and highlighted text.", options: ["text-editorial", "text-highlight", "text-balanced"] },
    { id: "reveal-hover", title: "Reveal on hover", target: ["text", "button", "image", "section", "page"], icon: "☝", description: "Reveal overlays or text treatments on hover.", options: ["hover-overlay-reveal", "hover-text-reveal", "image-curtain-reveal"] },
    { id: "scroll-indicators", title: "Scroll indicators", target: ["page"], icon: "⌄", description: "Add simple page scroll cues and progress.", options: ["scroll-indicator", "motion-scroll-progress"] },
    { id: "section-layouts", title: "Section layouts", target: ["section", "page"], icon: "▦", description: "Safe responsive layout presets for sections and cards.", options: ["layout-safe-container", "layout-balanced-section", "layout-responsive-cards", "section-sticky-pin"] }
  ];
  ...
  function featuresForCurrentTarget() {
    ...
    const preferredOrder = kind === "button"
      ? ["button-styles", "engagement-effects", "animate-hover", "reveal-hover", "cursor-hover", "animate-scroll"]
      : kind === "text"
        ? ["heading-styles", "paragraph-styles", "animate-hover", "reveal-hover", "animate-scroll", "block-styling"]
        : kind === "image"
          ? ["image-styles", "animated-image-shapes", "image-click-indicator", "gallery-styles", "animate-hover", "animate-scroll"]
          : kind === "page"
            ? ["header-styles", "header-links", "dropdown-menu", "mobile-menu", "scroll-indicators", "section-layouts", "button-styles", "heading-styles", "image-styles", "animate-scroll"]
            : ["section-layouts", "block-styling", "heading-styles", "paragraph-styles", "button-styles", "image-styles", "animated-shapes", "animate-hover", "animate-scroll", "engagement-effects", "gallery-styles"];
    return all.sort((a, b) => {
...
`;
  ...
  function ensureBaseStyles() {
    ...
    style.textContent = `
      ...
      #${APP_ID}{width:min(440px,calc(100vw - 28px))!important;max-height:calc(100vh - 18px)!important}
      #${APP_ID} .ssx-panel{display:grid!important;grid-template-rows:auto minmax(0,1fr) auto!important;max-height:calc(100vh - 18px)!important;min-height:360px!important;resize:both!important;overflow:auto!important}
      #${APP_ID} .ssx-body{min-height:0!important;overflow:hidden!important;max-height:none!important}
      #${APP_ID} .ssx-main{min-height:0!important;overflow-y:auto!important;overflow-x:hidden!important;max-height:none!important;padding-bottom:22px!important}
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v15 · stable editor</div>
          </div>
          <div class="ssx-icon-row">
            <button class="ssx-icon" type="button" data-ssx-pick title="Select on page">◎</button>
        ...
        <div class="ssx-body">
          <main class="ssx-main">
            ${helpOpen ? `<section class="ssx-how">
              ...
              <p>Select a block, open a feature, choose one preset, then click Publish. Reset removes all saved Studio Poema changes from this browser.</p>
            </section>` : ""}
            ${renderMainContent()}
          </main>
        </div>
  ...
  function renderFeatureDetail(featureId) {
    ...
    return `
      ...
      <div class="ssx-option-list">
        ...
        ${options.map((effect) => renderFeatureOption(feature, effect)).join("")}
      </div>
    `;
  }
  ...
  function bindPanel(root) {
    ...
    root.querySelectorAll("[data-ssx-feature-effect]").forEach((button) => {
      button.addEventListener("click", () => {
        ...
        feature.options.forEach((id) => {
          ...
          const other = effectById.get(id);
          if (other) setEffectSetting(currentScopeTarget(other), id, { enabled: false });
        });
        ...
        renderPanel();
        showToast(`${effect.label} applied`);
      });
    });
    ...
    root.querySelectorAll("[data-ssx-pick]").forEach((button) => button.addEventListener("click", startPicking));
