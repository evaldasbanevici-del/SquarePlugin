(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v11`;
  ...
  const featureLibrary = [
    {
      id: "button-styles",
      title: "Button styles",
      target: ["button", "section", "page"],
      icon: "▭",
      description: "A range of unique button styles that will get people clicking.",
      options: [
        "button-solid-style",
        "button-border-style",
        "button-magnetic",
    ...
    {
      id: "engagement-effects",
      title: "Engagement effects",
      target: ["button", "section", "page"],
      icon: "▣",
      description: "Draw attention to important buttons and increase conversions.",
      options: ["engagement-pulse", "engagement-wobble", "engagement-hovering", "engagement-jelly"]
    },
    {
      id: "text-styles",
      title: "Text styles",
      target: ["text", "section", "page"],
      icon: "T",
      description: "Modern heading and copy treatments for editorial templates.",
      options: ["text-editorial", "text-highlight", "text-gradient", "text-balanced", "text-typewriter", "text-3d-hover", "text-outline-trend", "text-split-luxury"]
    },
    {
      id: "image-styles",
      title: "Image styles",
      target: ["image", "section", "page"],
      icon: "◫",
      description: "Shape, tint, reveal and animate image blocks.",
      options: ["image-soft-shadow", "image-rounded", "image-zoom-hover", "image-duotone", "image-curtain-reveal", "image-floating-gallery", "image-infinite-gallery", "motion-ken-burns"]
    },
    {
      id: "section-layouts",
      ...
      target: ["section", "page"],
      icon: "▦",
      description: "Safe responsive layout presets for sections and cards.",
      options: ["layout-safe-container", "layout-balanced-section", "layout-responsive-cards", "section-split-grid", "section-sticky-pin", "section-divider-wave", "section-footer-reveal"]
    },
    {
      id: "motion-effects",
      title: "Motion effects",
      target: ["text", "button", "image", "section", "page"],
      icon: "✦",
      description: "Scroll, entry, shimmer and background motion effects.",
      options: ["motion-reveal", "motion-stagger", "motion-float", "motion-soft-breathe", "motion-clip-reveal", "motion-gradient-shift", "motion-scroll-progress", "motion-marquee", "motion-scroll-rotate", "motion-fixed-mark"]
    },
    {
      id: "hover-effects",
      title: "Hover effects",
      target: ["text", "button", "image", "section", "page"],
      icon: "↗",
      description: "Interactive hover states for blocks, links, media and text.",
      options: ["hover-transform-kit", "hover-color-border", "hover-image-filter", "hover-overlay-reveal", "hover-text-reveal", "cursor-block-tilt", "cursor-link-magnet"]
    },
    {
      id: "navigation",
      title: "Navigation",
      target: ["page", "section"],
      icon: "☰",
      description: "Header, menu, dropdown and navigation polish.",
      options: ["nav-glass", "nav-link-underline", "nav-pill-box", "nav-dropdown-glass", "nav-burger-polish", "nav-sticky-hover"]
    },
    {
      id: "utilities",
      title: "Utilities",
      target: ["section", "button", "text", "image", "page"],
      icon: "⚙",
      description: "Helpful setup tools, visibility, cursor and sticky helpers.",
      options: ["utility-selected-outline", "utility-test-bg", "utility-sticky", "utility-hide-mobile", "cursor-soft-dot", "cursor-emoji", "scroll-indicator"]
    }
  ];
  ...
  function featuresForCurrentTarget() {
    ...
    const preferredOrder = kind === "button"
      ? ["button-styles", "engagement-effects", "hover-effects", "motion-effects", "utilities"]
      : kind === "text"
        ? ["text-styles", "motion-effects", "hover-effects", "utilities"]
        : kind === "image"
          ? ["image-styles", "hover-effects", "motion-effects", "utilities"]
          : kind === "page"
            ? ["navigation", "motion-effects", "section-layouts", "utilities"]
            : ["section-layouts", "text-styles", "button-styles", "image-styles", "motion-effects", "hover-effects", "navigation", "utilities"];
    return all.sort((a, b) => {
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v11 · Spark-like editor</div>
          </div>
        ...
        <div class="ssx-upgrade">Select any block on the page. Studio Poema will show the right tools automatically.</div>
        ...
        <div class="ssx-body">
          <main class="ssx-main">
            <section class="ssx-how">
              <div class="ssx-how-title">How to use</div>
              <p>Click the select icon, choose text, image, button or section, then pick a preset. Hover rows for previews, use Restore to undo one feature, Clear all to reset this browser, and Publish to copy the final code.</p>
            </section>
            <div class="ssx-target">
              <div class="ssx-target-row">
                ...
                <button class="ssx-action" type="button" data-ssx-pick>Select</button>
              </div>
        ...
        <div class="ssx-footer">
          ...
          <button class="ssx-copy" type="button" data-ssx-clear>Clear all</button>
  ...
  function renderStudioDashboard() {
    ...
    return `
      <section class="ssx-studio-hero">
        <div>
          <div class="ssx-tool-title">${escapeHtml(targetKindLabel(kind))}</div>
          <p class="ssx-tool-desc">Only the tools that make sense for this selected element are shown here.</p>
        </div>
        <span class="ssx-scope-pill">Editing: ${config.scope === "global" ? "Whole page" : targetLabel(config.activeTarget)}</span>
      </section>
      <section class="ssx-publish-note">
        <span class="ssx-note-icon">?</span>
        <span>Hover any row to preview it. Open a feature, choose a preset, then adjust strength. Click Publish when you are happy.</span>
      </section>
      ...
      <details class="ssx-help-box">
        <summary>Help, reset and handoff</summary>
        <p><strong>Select:</strong> click Select and choose a block or section on the page. The panel will open tools for that type automatically.</p>
        <p><strong>Reset:</strong> use Restore inside a feature, or Clear all to remove everything saved in this browser.</p>
        <p><strong>Publish:</strong> copies the final install code. Paste that code into Squarespace Footer Code Injection or hand it to a client.</p>
      </details>
      ${renderThemeControls()}
    `;
  }
