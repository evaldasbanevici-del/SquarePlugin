(() => {
  ...
  const STORAGE_KEY = `${APP_ID}:config:v68`;
  ...
  const buttonStyleEffects = [
    {
      ...
      preview: "button-glow",
      css: (s, i, settings, theme) => {
        const className = "ssx-btn-bouncy-cta";
        const target = buttonClassTargets(s, className);
        ...
        const shift = Math.round(iconSize * .92);
        const hardTarget = ".ssx-btn-bouncy-cta,[data-ssx-bouncy-id]";
        return `${target},${hardTarget}{--ssx-bouncy-h:${height}px;--ssx-bouncy-shift:${shift}px;position:relative!important;display:inline-flex!important;align-items:center!important;justify-content:flex-start!important;width:fit-content!important;max-width:100%!important;min-width:0!important;height:auto!important;min-height:var(--ssx-bouncy-h)!important;padding:0!important;border:0!important;background:none!important;color:${text}!important;text-decoration:none!important;overflow:visible!important;isolation:isolate!important;line-height:1!important;box-shadow:none!important;transform-origin:center!important;} ${target}:hover,${hardTarget}:hover{opacity:1!important;} ${target} .d-flex,${hardTarget} .d-flex{display:flex!important;align-items:center!important;justify-content:center!important;} ${target} .spb-349-box,${hardTarget} .spb-349-box{position:relative!important;display:flex!important;align-items:center!important;height:var(--ssx-bouncy-h)!important;min-height:var(--ssx-bouncy-h)!important;} ${target} .spb-349-main,${hardTarget} .spb-349-main{position:relative!important;z-index:2!important;height:var(--ssx-bouncy-h)!important;min-height:var(--ssx-bouncy-h)!important;padding:0 ${pad}px!important;justify-content:center!important;border-radius:${radius}px!important;background:${fill}!important;color:${text}!important;border:1px solid ${hexToRgba(outline,.22)}!important;box-shadow:0 10px 24px ${hexToRgba(fill,.14)},inset 0 1px 0 ${hexToRgba("#ffffff",.32)}!important;transition:transform ${speed}s cubic-bezier(.33,1,.68,1),background ${speed}s cubic-bezier(.33,1,.68,1),box-shadow ${speed}s cubic-bezier(.33,1,.68,1)!important;white-space:nowrap!important;} ${target} .ssx-btn-label,${hardTarget} .ssx-btn-label{display:inline-block!important;position:relative!important;font-weight:900!important;line-height:1!important;white-space:nowrap!important;color:${text}!important;} ${target} :is(.spb-349-left,.spb-349-right),${hardTarget} :is(.spb-349-left,.spb-349-right){width:var(--ssx-bouncy-h)!important;height:var(--ssx-bouncy-h)!important;min-width:var(--ssx-bouncy-h)!important;max-width:var(--ssx-bouncy-h)!important;min-height:var(--ssx-bouncy-h)!important;max-height:var(--ssx-bouncy-h)!important;border-radius:50%!important;background:${hover}!important;color:${settings.outlineColor || theme.ink}!important;transition:transform ${speed}s cubic-bezier(.33,1,.68,1),border-radius ${speed}s cubic-bezier(.33,1,.68,1),background ${speed}s ease!important;box-shadow:inset 0 0 0 1px ${hexToRgba(settings.outlineColor || theme.ink,.16)}!important;overflow:hidden!important;line-height:1!important;flex:0 0 var(--ssx-bouncy-h)!important;} ${target} .spb-349-left,${hardTarget} .spb-349-left{position:absolute!important;left:0!important;top:0!important;z-index:1!important;transform:scale(1,.32) translateX(2px)!important;border-radius:30%!important;} ${target} .spb-349-right,${hardTarget} .spb-349-right{position:relative!important;z-index:3!important;transform:scale(1)!important;margin-left:0!important;} ${target} :is(.spb-349-left small,.spb-349-right small),${hardTarget} :is(.spb-349-left small,.spb-349-right small){display:block!important;font-size:${Math.round(height*.46)}px!important;line-height:1!important;font-weight:900!important;color:currentColor!important;transform:none;} ${target}:hover .spb-349-main,${hardTarget}:hover .spb-349-main{transform:translateX(var(--ssx-bouncy-shift))!important;background:${hover}!important;box-shadow:0 ${Math.round(12+i*10)}px ${Math.round(24+i*20)}px ${hexToRgba(hover,.18)},inset 0 1px 0 ${hexToRgba("#ffffff",.4)}!important;} ${target}:hover .spb-349-left,${hardTarget}:hover .spb-349-left{transform:scale(1)!important;border-radius:50%!important;z-index:3!important;} ${target}:hover .spb-349-right,${hardTarget}:hover .spb-349-right{transform:scale(1,.32) translateX(-2px)!important;border-radius:30%!important;z-index:1!important;} ${target} .spb-349-right small,${hardTarget} .spb-349-right small{animation:ssxSp349Anim ${speed}s cubic-bezier(.11,0,.5,0) forwards!important;animation-delay:calc(${speed}s / 4)!important;} ${target}:hover .spb-349-left small,${hardTarget}:hover .spb-349-left small{animation:ssxSp349Anim ${speed}s cubic-bezier(.11,0,.5,0) forwards!important;animation-delay:calc(${speed}s / 4)!important;} ${target}:hover .spb-349-right small,${hardTarget}:hover .spb-349-right small{animation:none!important;} ${target}:active,${hardTarget}:active{transform:scale(.97)!important;} @keyframes ssxSp349Anim{0%{transform:translate(-20%,10%)}70%{transform:translate(20%,-10%)}100%{transform:translate(0,0)}}`;
      }
    },
    {
  ...
  function buttonAdapterClassFor(effectId) {
    return {
      "btn-style-bouncy-cta": "ssx-btn-bouncy-cta",
  ...
  function restoreButtonAdapter(button) {
    ...
    ["ssx-btn-bouncy-cta", "ssx-btn-letter-flip", "ssx-btn-swap-arrow", "ssx-btn-arrow-push", "ssx-button-adapter"].forEach((className) => button.classList.remove(className));
...
`;
      ...
      <div class="ssx-panel" role="dialog" aria-label="Studio Poema">
        <div class="ssx-head" data-ssx-drag>
          ...
          <div>
            ...
            <div class="ssx-subtitle">v68 · spark style bouncy button</div>
          </div>
  ...
  function cleanRuntimeSrc() {
    const fallback = `https://cdn.jsdelivr.net/gh/evaldasbanevici-del/SquarePlugin@main/studio-poema-v68.js?v=${defaultConfig.version}`;
    try {
