/* ============================================================
   ...
   File: FormaPlugin-v2.js · Single-file injection · No dependencies
...
(() => {
  ...
  const state = {
    ...
    picking: false,
    hoverEl: null,
    ui: { open: new Set(["__colors"]), openFx: null, search: "", scrollTop: 0, showPub: false }
  };
...
#${IDS.root} .fm-head button{margin-left:auto}
...
<div class="fm-pub">
  ...
  /* ============================================================
     ...
     ============================================================ */
  function runtimeSrc() {
    const fallback = `https://cdn.jsdelivr.net/gh/evaldasbanevici-del/SquarePlugin@main/FormaPlugin-v2.js`;
    try {
